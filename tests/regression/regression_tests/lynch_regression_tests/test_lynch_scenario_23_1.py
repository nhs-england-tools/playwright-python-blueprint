...
def test_lynch_scenario_23_1(page: Page) -> None:
    """
    Scenario: : 23.1 - Unsuitable for symptomatic (do not cease) - self referral

    G4-G2-G3-A183-A25-J10-A99-A59-A259-A315-A360-A410-A415-A416-A316-A348-A372-A357-A356-C203-[SSCL22d]
