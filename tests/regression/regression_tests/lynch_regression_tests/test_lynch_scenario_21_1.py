...
def test_lynch_scenario_21_1(page: Page) -> None:
    """
    Scenario: : 21.1 - Cancer result from diagnostic tests - self referral

    G4-G2-G3-A183-A25-J10-A99-A59-A259-A315-A361-A323-A317-A345-A346-A63-C203-Lynch in age [SSCL19c]
