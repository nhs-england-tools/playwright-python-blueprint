...
def test_lynch_scenario_2_1(page: Page) -> None:
    """
    Scenario: 2.1 - Screening Centre discharges patient prior to colonoscopy assessment - self referral

    G4-G2-G3-A183-A25-J24-J25-J26-C203 above age range [SSCL5b(J26)]
    ...
    batch_processing(
        page,
        "J24",
        "Subject Discharge (Screening Centre) (Lynch)",
    )
    ...
    SubjectRepository().there_is_letter_batch_for_subject(
        nhs_no,
        "J25",
        "GP Discharge (Discharged By Screening Centre) (Lynch)",
    )
    ...
    # Then Comment:
    logging.info("Check subject details against closure scenario SSCL5b(J26) ")
