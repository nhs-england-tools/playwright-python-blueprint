...
def test_lynch_scenario_12_1(page: Page) -> None:
    """
    Scenario: 12.1 - Abnormal result from diagnostic tests - self referral

    G4-G2-G3-A183-A25-J10-A99-A59-A259-A315-A361-A323-A317-A318-A65-Lynch over age [SSCL11e]

    This scenario tests progression of a Lynch episode for a below-age subject to closure on A65 Abnormal from diagnostic test results (but not symptomatic procedure results).
    ...
    > Process A318 letter batch > A65 (2.1)
    ...
    # And I apply the "Abnormal" Investigation Dataset Scenario
