...
- [perform-static-analysis.sh](../../blueprint_specific/scripts/reports/perform-static-analysis.sh): A shell script that performs analysis
- [sonar-scanner.properties](../../blueprint_specific/scripts/config/sonar-scanner.properties): A configuration file that includes the project details
...
./blueprint_specific/scripts/reports/perform-static-analysis.sh
```
...
- In the [sonar-scanner.properties](../../blueprint_specific/scripts/config/sonar-scanner.properties) file in your repository, set the following properties according to the information provided above
