...
- [`create-sbom-report.sh`](../../blueprint_specific/scripts/reports/create-sbom-report.sh): A shell script that generates SBOM (Software Bill of Materials)
- [`syft.yaml`](../../blueprint_specific/scripts/config/syft.yaml): A configuration file for the SBOM generator
- [`scan-vulnerabilities.sh`](../../blueprint_specific/scripts/reports/scan-vulnerabilities.sh): A shell script that performs CVE analysis
- [`grype.yaml`](../../blueprint_specific/scripts/config/grype.yaml): A configuration file for the CVE scanner
...
- [Adjust the configuration settings](../../blueprint_specific/scripts/config/grype.yaml) to align with your project's specific requirements
...
```shell
./blueprint_specific/scripts/reports/create-sbom-report.sh
...
```shell
./blueprint_specific/scripts/reports/scan-vulnerabilities.sh
