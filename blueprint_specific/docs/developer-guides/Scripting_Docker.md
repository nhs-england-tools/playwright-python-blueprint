...
This file is then used by functions defined in [docker.lib.sh](../../blueprint_specific/scripts/docker/docker.lib.sh) but is ignored by Git, and is not checked in with other files.
