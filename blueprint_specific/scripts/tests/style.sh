...
check=working-tree-changes ./blueprint_specific/scripts/githooks/check-english-usage.sh && \
  check=staged-changes ./blueprint_specific/scripts/githooks/check-english-usage.sh
